...
//对角度计算的卡尔曼滤波器
class Kalman_Angle_Class :public Kalman_Class
{
public:
	//噪声需由实验测量获取
	Kalman_Angle_Class() :noise_process_omega(0.000005f), noise_measurement_omega(0.0031f) {}
...
private:
	...
	float noise_process_omega;	//编码器角速度噪声，执行噪声
	float noise_measurement_omega;	//陀螺仪角速度噪声，测量噪声

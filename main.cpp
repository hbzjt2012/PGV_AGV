...
int main(void)
{
	...
	AGV_Target_Velocity_InWorld.velocity = 0.0f;
	AGV_Target_Velocity_InWorld.velocity_angle = 0.0f;
	AGV_Target_Velocity_InWorld.angular_velocity = 0.0f;
	...
	Mecanum_AGV.AGV_Control_Class::Write_Velocity(AGV_Current_Coor_InWorld, AGV_Target_Coor_InWorld, AGV_Target_Velocity_InWorld);
